...
export const meetings: SacramentMeeting[] = [
  ...
  },
  {
    ...
    wardBusinessItem: [
      { description: "Discussion on upcoming ward activities" },
    ],
    stakeBusiness: false,
    sacramentHymn: { number: 5, title: "The Spirit of God" },
    speakers: [
      {
        name: "Sister Nia Patel",
        topic: " Being prepared for service",
        type: "speaker",
      },
    ],
  ...
  },
  {
    ...
    speakers: [
      {
        name: "Brother Theo Grant",
        topic: "Gratitude and Service",
        type: "speaker",
      },
    ],
    intermediateHymn: { number: 4, title: "Be Still, My Soul" },
